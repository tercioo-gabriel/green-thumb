...
const Navbar = () =>{
  return(
    <div className="z-50 fixed layoutDefault flex flex-col w-full shadow-3xl">
      <div className="flex items-center justify-center h-8 bg-verde text-white text-sm tracking-wider">
        <p>FREE SHIPPING ON ALL FULL SUN PLANTS! FEB. 25–28.</p>
      </div>
      <div className="flex h-14 bg-white items-center justify-around">
        <h3 className="font-semibold text-2xl tracking-tight"><span className="text-verde">Green</span> Thumb</h3>
